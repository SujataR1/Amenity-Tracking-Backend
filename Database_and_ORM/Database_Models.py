...
class User(Model):
    ...
    # FIXED: BigIntField max_length is invalid
...
# =========================================================
# QUESTIONNAIRE (ML INPUT DATASET)
# =========================================================
...
class Admin(Model):
    ...
    role = fields.CharEnumField(RoleEnum, default=RoleEnum.admin)
...
# =========================================================
# ELECTRICITY (ML + PREDICTION ENABLED)
# =========================================================
